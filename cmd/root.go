...
var rootCmd = &cobra.Command{
	Use:   "passgen",
	Short: "A simple and secure password generator",
	Long:  `A simple and secure password generator`,
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".passgen" (without extension).
